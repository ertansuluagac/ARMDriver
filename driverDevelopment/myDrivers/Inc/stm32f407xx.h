...
#define SRAM2_BASE_ADDR					(0x2001C0000UL)	/*SRAM2 Base Address 16KB        */
...
typedef struct
{
	...
	__IO uint32_t PUPDR;	                /*!< GPIO port pull-up/puul-down register 	 Address Offset = 0x000C */
...
typedef struct
{
	...
	__IO uint32_t AHB2RSTR;                /*!< RCC AHB1 peripheral reset register                                          Address Offset = 0x0014*/
	__IO uint32_t AHB3RSTR;                /*!< RCC AHB1 peripheral reset register                                          Address Offset = 0x0018*/
	...
	__IO uint32_t APB1LPENR;               /*!< RCC APB1 peripheral clock in low power mode register                        Address Offset = 0x0060*/
	__IO uint32_t APB2LPENR;               /*!< RCC APB1 peripheral clock in low power mode register                        Address Offset = 0x0064*/
	...
	__IO uint32_t CSSR;                    /*!< RCC clock control & status register                                         Address Offset = 0x0074*/
...
#define	RCC_AHB1ENR_GPIOBEN_Pos			(1U)                                            // RCC AHB1 register GPIOBEN Bit Position
#define RCC_AHB1ENR_GPIOBEN_Msk			(0x1 << RCC_AHB1ENR_GPIOBEN_Pos)                // RCC AHB1 register GPIOBEN Bit Mask
#define RCC_AHB1ENR_GPIOBEN				 RCC_AHB1ENR_GPIOBEN_Msk                        // RCC AHB1 register GPIOBEN Macro

#define	RCC_AHB1ENR_GPIOCEN_Pos			(2U)                                            // RCC AHB1 register GPIOCEN Bit Position
#define RCC_AHB1ENR_GPIOCEN_Msk			(0x1 << RCC_AHB1ENR_GPIOCEN_Pos)                // RCC AHB1 register GPIOCEN Bit Mask
#define RCC_AHB1ENR_GPIOCEN				 RCC_AHB1ENR_GPIOCEN_Msk                         // RCC AHB1 register GPIOCEN Macro

#define RCC_AHB1ENR_GPIODEN_Pos			(3U)                                            // RCC AHB1 register GPIODEN Bit Position
#define RCC_AHB1ENR_GPIODEN_Msk			(0x1 << RCC_AHB1ENR_GPIODEN_Pos)                // RCC AHB1 register GPIODEN Bit Mask
#define RCC_AHB1ENR_GPIODEN				 RCC_AHB1ENR_GPIODEN_Msk                         // RCC AHB1 register GPIODEN Macro

#define RCC_AHB1ENR_GPIOEEN_Pos		    (4U)	                                        // RCC AHB1 register GPIOEEN Bit Position
#define RCC_AHB1ENR_GPIOEEN_Msk			(0x1 << RCC_AHB1ENR_GPIOEEN_Pos)                // RCC AHB1 register GPIOEEN Bit Mask
#define RCC_AHB1ENR_GPIOEEN				 RCC_AHB1ENR_GPIOEEN_Msk                         // RCC AHB1 register GPIOEEN Macro
